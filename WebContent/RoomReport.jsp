...
<center>
<div>
<h1 style="color:#AEB6BF;"><b/>Room Details Report</h1>
<div style="float: right; margin-right: 260px;" >
	<a href="#"><button type="button" style="background-color:#85C1E9; width:150px; height:40px; font-size: 20px;"><b/>Download</button></a>
