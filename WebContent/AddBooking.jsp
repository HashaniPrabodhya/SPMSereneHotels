...
<br><br>
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="date" id="from" name="from" placeholder="MM/DD/YYY">
    </div>
  </div>
   <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="date" id="to" name="to" placeholder="MM/DD/YYY">
    </div>
  </div>
    ...
    <div class="col-75">
      <input type="text" id="noNights" name="noNights" placeholder="Enter Number Of nights">
    </div>
  </div>
    ...
    <div class="col-75">
      <input type="text" id="noAdults" name="noAdults" placeholder="Enter Number Of Adults">
    </div>
  </div>
    ...
    <div class="col-75">
      <input type="text" id="noChildren" name="noChildren" placeholder="Enter Number Of Children">
    </div>
  </div>
