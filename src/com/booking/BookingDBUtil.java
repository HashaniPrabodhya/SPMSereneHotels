...
public class BookingDBUtil {
	...
	public static List<Booking>getBookings(String userName){
		...
		try {
			...
			while(rs.next()) {
				...
				Booking bookings =new Booking(bookingId,customerName,accommodationType,from,to,noNights,noAdults,noChildren,phone,uName);
	...
	public static boolean insertBooking(String customerName, String accomodationType, String from, String to,String noNights, String noAdults,
		...
		try {
			con=DBConnect.getConnection();
			stmt=con.createStatement();
			String sql="insert into booking values (0,'" +customerName+"', '" +accomodationType+"', '" + from+"', '" + to+"', '" + noNights+"','" + noAdults+"','" + noChildren+"', '" + phone+"', '" + userName+"')";
...
/*public static boolean updateBooking(String bookingId,String customerName, String accomodationType, String from, String to, String noNights, String noAdults,
			String noChildren, String phone, String userName) {
		try {
			con=DBConnect.getConnection();
			stmt=con.createStatement();
	...
	public static List<Booking>getBookingDetails(String bookingId){
		...
		try {
			...
			while(rs.next()) {
				...
				Booking Bookings =new Booking(bookingsId,customerName,accommodationType,from,to,noNights,noAdults,noChildren,phone,uName);
